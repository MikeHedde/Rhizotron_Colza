...
Rhizotron_Colza <img src="man/figures/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
=========================================================
...
Launch the [`make.R`](https://github.com/MikeHedde/Rhizotron_Colza/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/MikeHedde/Rhizotron_Colza/blob/main/CONTRIBUTING.md).
